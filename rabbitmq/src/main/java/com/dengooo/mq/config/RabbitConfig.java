package com.dengooo.mq.config;

import com.dengooo.mq.RmConst;
import com.dengooo.mq.hello.UserReceiver;
...
public class RabbitConfig {
    ...
    public DirectExchange directExchange() {
        return new DirectExchange(RmConst.EXCHANGE_DIRECT);
    }
    //TODO 绑定关系
    @Bean
    public Binding directExchangeMessage() {
